"""Master.
Usage:
  master.py -k N -n N -s N (-q N | -d N -a N)
  master.py interrupt -i N -k N -n N -s N (-q N | -d N -a N)
  master.py polling -k N -n N -s N (-q N | -d N -a N)
  master.py hybrid -i N -k N -n N -s N (-q N | -d N -a N)
  master.py --help
